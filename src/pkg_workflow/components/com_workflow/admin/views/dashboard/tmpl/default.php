    ...
    <div class="span8 hidden-phone">
            <?php if ($this->user->authorise('core.admin')) : ?>
                <a class="thumbnail btn pull-left" href="<?php echo JRoute::_('index.php?option=com_config&view=component&component=com_workflow');?>">
                    <?php echo JHtml::image('com_workflow/workflow/header/icon-48-config.png', JText::_('COM_PROJECTFORK_DASHBOARD_CONFIG'), null, true); ?>
        ...
        <div class="well well-small">
            ...
            <div class="alert alert-info small">
            	...
            	<ul class="unstyled">
            	    ...
            	    <li><small>Workflow Version: <?php echo WFVERSION; ?> <?php echo $pfv->DEV_STATUS;?></small></li>
